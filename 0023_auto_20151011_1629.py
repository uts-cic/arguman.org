...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='contention',
            name='owner',
            field=models.CharField(help_text='\nThe 'owner' of the argument. This might be an institution, a person, book or a paper, or some group of stakeholders who have a stake in the argument. Examples: <ul> <li>On the Origin of Species</li> <li>Friedrich Nietzsche</li> <li>Piet Mondiran</li> <li>The Guardian</li> </ul>', max_length=255, null=True, verbose_name='Who makes this claim?', blank=True),
        ),
        migrations.AlterField(
            model_name='contention',
            name='sources',
            field=models.TextField(help_text='\nThe source of the argument. It can be a URL, a book, or a newspaper. This is important for understanding who is making the main contention and how reliable it might be.\n', null=True, verbose_name='Sources', blank=True),
        ),
        migrations.AlterField(
            model_name='contention',
            name='title',
            field=models.CharField(help_text='\nThe main contention or claim being made. This is the main issue that the argument is about. The premises will support or rebut this main claim.<br> Examples: <ul> <li>Real art is for society, not for profit</li> <li>The meaning of life is 42</li> <li>Ethics man did what had to be done</li> </ul>', max_length=255, verbose_name='Argument'),
        ),
        migrations.AlterField(
            model_name='premise',
            name='is_approved',
